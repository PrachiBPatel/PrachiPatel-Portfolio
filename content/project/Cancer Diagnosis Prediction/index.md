...
|Drk      |atient drinks alcohol (0=No, 1=Yes)                                                                                                      |
...
<img src="{{< blogdown/postref >}}index_files/figure-html/unnamed-chunk-8-6.png" width="672" />

```r
densityplot( ~ ExcelFile$HW, pch=6,col=c("#e8bbfa"), xlab = "Height to Weight")
```

<img src="{{< blogdown/postref >}}index_files/figure-html/unnamed-chunk-8-7.png" width="672" />
...
<img src="{{< blogdown/postref >}}index_files/figure-html/unnamed-chunk-8-8.png" width="672" />
...
<img src="{{< blogdown/postref >}}index_files/figure-html/unnamed-chunk-8-9.png" width="672" />

```r
densityplot( ~ ExcelFile$Exe, pch=6,col=c("#6bc9c2"), xlab = "Exercise")
```

<img src="{{< blogdown/postref >}}index_files/figure-html/unnamed-chunk-8-10.png" width="672" />
...
<img src="{{< blogdown/postref >}}index_files/figure-html/unnamed-chunk-8-11.png" width="672" />
...
<img src="{{< blogdown/postref >}}index_files/figure-html/unnamed-chunk-8-12.png" width="672" />
