...
data.frame(Variable = c("ID","gender","HR","BP","Wgt1","Wgt2","Hgt","Smoke","Drink","Exercise","Group","WBC","Incode"),
           Description = c("UserID (unique to each respondent)","Gender of patient","Heart Rate (Low, Normal, High)","Patient Weight 1 week before test start","Patient Weight at test start","Height of patient in inches","Does the patient smoke?","Does the patient drink alcohol?","Minutes per week patient exercises","Test/Control","White Blood Cell Count","Annual Income")) |>
  knitr::kable()
```
